...
@section('content')
    ...
    <div class="container-fluid pb-5">
        <div class="ms-5 text-dark my-3 btn">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-2 " style="width: 170px;">
                            ...
                            <input type="text" class="form-control bg-secondary border-0 text-center" style="width: 35px" value="1" id="orderCount">
                            ...
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <div class="product-action">
                                    ...
                                    <a class="btn btn-outline-dark btn-square"
                                        href="{{ route('user#pizzaDetails', $item->id) }}"><i
